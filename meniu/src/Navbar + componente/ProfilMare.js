    ...
    return (
        <div className = 'bodyProfilMare'>
            <article className = 'articleProfilMare'>
                <img style = {{width: '400px', height: '100px', marginTop: '20px'}} src = {LogoCinematrixAlb} alt="" />
                <h1 className = 'h1ProfilMare2'>Esti in modul <b>MEMBRU</b></h1>
                <p className = 'pProfilMare'>Multumim pentru ca ai ales site-ul nostru! <br></br><br></br> Profil: <br></br>Nume: {userJSONParsed.nume} <br></br> Email: {userJSONParsed.email} <br></br> Daca ti-ai pierdut parola sau vrei sa o schimbi, apasa pe <Link style = {{border: '1px solid white', padding: '5px', borderRadius: '5px'}} to = '/reset'>Resetare parola</Link> <br></br><br></br> Daca te putem ajuta cu orice altceva, anunta-ne cu ajutorul paginii CONTACT. Enjoy! <RiEmotionHappyLine style = {{color: 'hsl(204 100% 59%)', width: '25px', height: '25px', marginTop: '-4px', marginLeft: '-7px'}}></RiEmotionHappyLine><br></br><br></br><p style = {{marginLeft: '700px'}}>Echipa Cinematrix</p></p>
        ...
        return (
            <div className = 'bodyProfilMare'>
                <article className = 'articleProfilMare'>
                    <img style = {{width: '400px', height: '100px', marginTop: '20px'}} src = {LogoCinematrixAlb} alt="" />
                    <h1 className = 'h1ProfilMare'>Esti in modul <b>TRECATOR</b></h1>
