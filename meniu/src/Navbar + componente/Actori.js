...
const Actori = () => {
    return (
        <div>
            ...
            <h6 data-bs-toggle="tooltip" data-bs-placement="top" title="Jean-Luc Godard" style = {{float: 'left', marginLeft: 50, marginTop: 15, color: '#0275d8', fontStyle: 'oblique'}}>"Photography is truth. The cinema is truth twenty-four times..." <BsChatQuote style = {{width: '25px', height: '25px', marginTop: '-5px', marginLeft: '8px'}}></BsChatQuote></h6>
            </header>
