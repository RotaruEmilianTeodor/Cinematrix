...
const Ajutor = () => {
    return (
        <div>
            ...
            <h6 data-bs-toggle="tooltip" data-bs-placement="top" title="Robert Kiyosaki" style = {{float: 'left', marginLeft: 30, marginTop: 15, color: '#0275d8', fontStyle: 'oblique'}}>"One of the biggest defects in life is the inability to ask for help" <BsChatQuote style = {{width: '25px', height: '25px', marginTop: '-5px', marginLeft: '8px'}}></BsChatQuote></h6>
            </header>
