        ...
        <div style = {{backgroundImage: `url(${background})`}} className="background">
            <div className = 'formLogin'>
                <div className="form-inner">
                    ...
                    <p style = {{fontFamily: 'Poppins', fontSize: '16px'}}>Bine te-am regasit! <BiHappyBeaming style = {{width: '20px', height: '20px', marginTop: '-2px'}}></BiHappyBeaming></p>
                    ...
                    <p style = {{fontFamily: 'Poppins', fontSize: '16px', marginTop: '5px', marginBottom: '-5px'}}>Distractie placuta!</p>
                    <p style = {{fontFamily: 'Poppins', fontSize: '13px', marginTop: '5px', fontWeight: 'lighter'}}>Echipa CINEMATRIX</p>
