...
const SEARCH_API = "https://api.themoviedb.org/3/search/tv?&api_key=2d7f5ba449370c217df98de84358761d&query="
...
function RecomandariSeriale() {
  ...
  return (
    <>
      ...
      <h3 className = 'textRecomandari' style = {{marginLeft: 55}}>Recomandari Seriale</h3>
      ...
      {seriale.length > 0 ? seriale.map(serial => (
          <SerialRecomandari key={serial.id} {...serial}></SerialRecomandari>
        )) : (
...
export default RecomandariSeriale
