...
function ActoriSeriale() {
  ...
  return (
    <>
      ...
      <h3 className = 'textRecomandari' style = {{marginLeft: 55}}>Actori Seriale</h3>
      ...
      {filme.length > 0 ? filme.map(film => (
          <ActorSerial key={film.id} {...film}></ActorSerial>
        )) : (
