...
const ActorSerial = ({ name, poster_path, backdrop_path, id }) => {
            ...
            <div className="similarMovies">          
                {actors.length > 0 ? actors.map(actor => (
                    ...
                    <h2 style = {{color: 'black', marginTop: '180px', marginLeft: '250px'}} className="no-movies">
                        <AiOutlineAlert style = {{width: '40px', height: '40px', marginTop: '-5px'}}></AiOutlineAlert> Ups... Nu exista momentan niciun actor de afisat pentru acest serial
