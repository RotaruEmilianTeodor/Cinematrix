...
const SerialRecomandari = ({ name, poster_path, backdrop_path, id }) => {
    ...
    return (
        <div style = {{boxShadow: '0px 4px 7px rgba(0,0,0,.9)'}} className='movie-recomandari'>
            ...
            <h4 style = {{marginLeft: '10px', marginTop: '5px', fontWeight: 'lighter'}}>Daca ti-a placut serialul <span style = {{color: 'black'}} class="badge bg-dark text-white">{name}</span> incearca si...</h4> 
